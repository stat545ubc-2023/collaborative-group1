...
### CORRECT CODE ###
#note: I did not have the "dslabs" package; first, install the package!
...
### CORRECT CODE ###
filter(movieLens, genres == "Drama") #belong *exclusively* to the genre *"Drama"* [original code was correct]
filter(movieLens, !genres == "Drama") #don't belong *exclusively* to the genre *"Drama"* [original code was correct]
filter(movieLens, year > 2000) #were filmed *after* the year 2000 [original code was INCORRECT]
filter(movieLens, year %in% c(1999, 2000)) #were filmed in 1999 *or* 2000 [original code was INCORRECT]
filter(movieLens, rating > 4.5, year < 1995) #have *more than* 4.5 stars, and were filmed *before* 1995 [original code was correct]
