...
### ISSUE: as_tibble function is not available in the dslabs package. To convert the dataset to a tibble, we can use the as_tibble function from the tibble package, which is part of the tidyverse. Therefore, we need to call the "tibble" library. 
...
### ISSUE: we need to use the summarize function
